describe "Pig Latinizer App" do
  ...
  describe "POST '/piglatinize'" do
    ...
    it "displays the pig latinized phrase upon form submission" do
      expect(last_response.body).to include("Once upon a time and a very good time it was there was a moocow coming down along the road and this moocow that was coming down along the road met a nice little boy named baby tuckooway")
    end
  end
  ...
  describe "POST '/piglatinize' again" do
    ...
    it "displays the pig latinized phrase upon form submission" do
      expect(last_response.body).to include("e was an old man who fished alone in a skiff in the Gulf Stream and he had gone eighty four days now without taking a fishHay")
    end
  end
